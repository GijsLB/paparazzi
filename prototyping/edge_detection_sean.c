“””
/*
 * filename: edge_cv_detect_color_object
 *
 ...
 * 
 * This file is the modified version of cv_detect_color_object. It now includes the edge detector.
 * A separate file is made as we made the choice to not integrate this module with the image segmentation
 * method. 
 */
