 ...
 */
#ifndef CUSTOM_AVOIDER_VISUAL_DETECTION_ID
#define CUSTOM_AVOIDER_VISUAL_DETECTION_ID ABI_BROADCAST
#endif
...
void custom_avoider_init(void)
{
  ...
  AbiBindMsgVISUAL_DETECTION(CUSTOM_AVOIDER_VISUAL_DETECTION_ID, &color_detection_ev, color_detection_cb);
}
