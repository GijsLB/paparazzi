...
- `ground_filter.c` and `ground_filter_bauke.c`
  First attempt at turning the python perception logic into C. 

- `heading.py`  
  Steering logic which steers to the highest column. This logic was eventually ruled out. 
...
### Supporting Config Files (minor changes):
